...
def get_card_type(hand: str) -> str:
    ...
    if 'J' in hand and len(cards) > 1:
        most_common = cards.most_common()
        most_common_card = most_common[1][0] if most_common[0][0] == 'J' else most_common[0][0]
        new_hand = hand.replace('J', most_common_card)
        cards = collections.Counter(new_hand)
...
print()
print(get_card_type('TTTTJ'))
print(get_card_type('TTTJJ'))
print(get_card_type('123JJ'))
print()
